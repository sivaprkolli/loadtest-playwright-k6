...
export default function main() {
  ...
  group('page@9d216e25ca08185b9aac2d921893d37c - StackDemo', function () {
    ...
    response = http.get(
      'https://bugbash.online/_next/static/chunks/pages/checkout-3f66f386b41904cff833.js',
      {
        headers: {
          Accept: '*/*',
          'Accept-Encoding': 'gzip, deflate, br, zstd',
    ...
    response = http.get('https://bugbash.online/favicon.svg', {
      headers: {
        ...
        Connection: 'keep-alive',
        Host: 'bugbash.online',
        Referer: 'https://bugbash.online/checkout',
        'Sec-Fetch-Dest': 'image',
        'Sec-Fetch-Mode': 'no-cors',
        'Sec-Fetch-Site': 'same-origin',
        'User-Agent':
    ...
    response = http.post('https://bugbash.online/api/checkout', '{"userName":"demouser"}', {
      headers: {
        Accept: 'application/json, text/plain, */*',
        'Accept-Encoding': 'gzip, deflate, br, zstd',
        'Accept-Language': 'en-US',
    ...
    response = http.get(
      'https://bugbash.online/_next/static/chunks/e78312c5.0ae29da10b8cbfe2032d.js',
      {
        headers: {
          Accept: '*/*',
          'Accept-Encoding': 'gzip, deflate, br, zstd',
    ...
    response = http.get(
      'https://bugbash.online/_next/static/chunks/pages/confirmation-49ed9afb00468d634016.js',
      {
        headers: {
          Accept: '*/*',
          'Accept-Encoding': 'gzip, deflate, br, zstd',
    ...
    response = http.get('https://bugbash.online/favicon.svg', {
      headers: {
        ...
        Connection: 'keep-alive',
        Host: 'bugbash.online',
        Referer: 'https://bugbash.online/confirmation',
        'Sec-Fetch-Dest': 'image',
        'Sec-Fetch-Mode': 'no-cors',
        'Sec-Fetch-Site': 'same-origin',
        'User-Agent':
